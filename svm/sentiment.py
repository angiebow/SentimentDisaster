...
INPUT_FOLDER = ROOT / "unified"
OUTPUT_FILE = ROOT / "labeled_sentiment_data_unified.csv"
MODEL_FILE = SVM_DIR / "sentiment_models" / "svm_sentiment_model_unified.pkl"
VECTORIZER_FILE = SVM_DIR / "sentiment_models" / "tfidf_vectorizer.pkl"
